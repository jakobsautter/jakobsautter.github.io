        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-3 col-12 text-center tech-icon">
                    ...
                    <i-mdi-language-java title="java" />
                    <i-mdi-language-javascript title="javascript" />
                    <i-mdi-language-typescript title="typescript" />
                    <i-mdi-language-csharp title="csharp" />
                </div>

                <div class="col-lg-3 col-12 text-center tech-icon">
                    <h3 class="mb-4 mobile-mt-2">Frontend</h3>
                    <i-mdi-vuejs title="vue" />
                    <i-mdi-vuetify title="vuetify" />
                    <i-mdi-bootstrap title="bootstrap" />
                    <i-mdi-language-html5 title="html5" />
                    <i-mdi-language-css3 title="css3" />
                    <i-ion-logo-sass title="sass" />
                </div>

                <div class="col-lg-3 col-12 text-center tech-icon">
                    <h3 class="mb-4 mobile-mt-2">Backend</h3>
                    <i-simple-icons-spring title="spring" />
                    <i-simple-icons-springboot title="springboot" />
                    <svg width="1em" height="1em" viewBox="0 0 32 32" title="aspnet">
                        <path
                            fill="#606060"
                    ...
                    <i-simple-icons-mysql title="mysql" />
                    <i-simple-icons-postgresql title="postgresql" />
                    <i-simple-icons-microsoftsqlserver title="msssql" />
                </div>

                <div class="col-lg-3 col-12 text-center tech-icon">
                    <h3 class="mb-4 mobile-mt-2">Tools</h3>
                    <i-uil-github title="github" />
                    <i-mdi-microsoft-visual-studio-code title="vscode" />
                    <i-mdi-microsoft-visual-studio title="visualstudio" />
                    <i-simple-icons-resharper title="resharper" />
                    <i-simple-icons-rider title="rider" />
                    <i-simple-icons-intellijidea title="intellijidea" />
                    <i-simple-icons-teamcity title="teamcity" />
                    <i-simple-icons-jenkins title="jenkins" />
                    <i-simple-icons-docker title="docker" />
                    <i-simple-icons-jirasoftware title="jira" />
                    <i-simple-icons-confluence title="confluence" />
                    <i-simple-icons-bitbucket title="bitbucket" />
                </div>
            </div>
        </div>
    </section>
